                ...
                {openSections.modes && (
                    <div className="statistics-section-body">
                        ...
                        <div className="statistics-note-card">
                            ...
                            <strong>{campaignProgressLabel || `Stage ${Math.min(totalCampaignStages, campaignLevel + 1)} / ${totalCampaignStages}`}</strong>
                        </div>
                    </div>
                )}
            </div>
