...
export const ACHIEVEMENT_DEFINITIONS: AchievementDefinition[] = [
    ...
    },
    {
        ...
        description: 'Beat the tutorial by completing every tutorial objective or by adding a bot and defeating it.',
        category: 'Campaign',
        target: 1,
        getCurrent: () => 0,
    },
    ...
    },
    {
        id: 'BOT_LEVEL_7',
        title: 'Bot Hunter 7',
        description: 'Defeat a level 7 bot.',
        category: 'Co-op',
        target: 1,
        getCurrent: () => 0,
    },
    {
        id: 'BOT_LEVEL_8',
        title: 'Bot Hunter 8',
        description: 'Defeat a level 8 bot.',
        category: 'Co-op',
        target: 1,
        getCurrent: () => 0,
    },
    {
        id: 'BOT_LEVEL_9',
        title: 'Bot Hunter 9',
        description: 'Defeat a level 9 bot.',
        category: 'Co-op',
        target: 1,
        getCurrent: () => 0,
    },
    {
        id: 'BOT_LEVEL_10',
        title: 'Bot Hunter 10',
        description: 'Defeat a level 10 bot.',
        category: 'Co-op',
        target: 1,
        getCurrent: () => 0,
    },
