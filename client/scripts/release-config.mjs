...
export const currentRendererDistDir = path.join(clientDir, "dist");
export const currentServerDistDir = path.join(clientDir, "server", "dist");
export const testOutputRoot = path.join(clientDir, "tests", "output");
export const platformTestOutputRoot = path.join(testOutputRoot, "platforms");
...
export const platforms = [
  {
    ...
    rendererDir: path.join(stageDir("microsoft-windows"), "resources", "dist"),
    rendererIndexPath: path.join(stageDir("microsoft-windows"), "resources", "dist", "index.html"),
    serverDistDir: path.join(stageDir("microsoft-windows"), "resources", "server", "dist"),
  ...
  },
  {
    ...
    rendererDir: path.join(stageDir("linux"), "resources", "dist"),
    rendererIndexPath: path.join(stageDir("linux"), "resources", "dist", "index.html"),
    serverDistDir: path.join(stageDir("linux"), "resources", "server", "dist"),
...
export function getPlatformTestOutputDir(platformKey) {
  return path.join(platformTestOutputRoot, platformKey);
}
