...
async function main() {
    ...
    const botGoldBeforeReady = botPlayer!.resources.gold;
    const humanGoldBeforeReady = humanPlayer!.resources.gold;
    ...
    assert(botGoldBeforeReady === 4000, `expected bot gold to stay frozen before ready, got ${botGoldBeforeReady}`);
    assert(humanGoldBeforeReady === 4000, `expected human gold to stay frozen before ready, got ${humanGoldBeforeReady}`);
